...
This extension just clicks [Load more] for you up front, until it's all there. (And logs progress to the console.)
...
Open DevTools and check the Console to see the loading progress.